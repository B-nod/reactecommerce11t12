...
const Cart = () => {
  ...
  const removeCartHandle =(id,title)=>{
    ...
    if(confirmed){
      ...
      toast.success(`${title} is removed fromt the cart.`)
    }
  }
                      ...
                      <div className="flex items-center">
                        ...
                        type="button"
                         ...
                         onClick={()=>increaseQty(item.id)}
                          data-input-counter-increment="counter-input" className="inline-flex h-5 w-5 shrink-0 items-center justify-center rounded-md border border-gray-300 bg-gray-100 hover:bg-gray-200 focus:outline-none focus:ring-2 focus:ring-gray-100 dark:border-gray-600 dark:bg-gray-700 dark:hover:bg-gray-600 dark:focus:ring-gray-700">
        ...
        <div className="space-y-4 rounded-lg border border-gray-200 bg-white p-4 shadow-sm dark:border-gray-700 dark:bg-gray-800 sm:p-6">
          ...
          <div className="space-y-4">
            ...
            <dl className="flex items-center justify-between gap-4 border-t border-gray-200 pt-2 dark:border-gray-700">
              ...
              <dd className="text-base font-bold text-gray-900 dark:text-white">{products.reduce((ac,item)=>(ac+item.price*item.quantity), 0)}</dd>
            </dl>
          </div>
